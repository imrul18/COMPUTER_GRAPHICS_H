...
void quads (GLfloat a,GLfloat b,GLfloat c,GLfloat d)
{
    glVertex2f(a, b);
    glVertex2f(c, b);
    glVertex2f(c, d);
...
//thin pillars
   ...
   glBegin(GL_QUADS);
      glColor3f(0.0f, 0.0f, 0.0f);
      glVertex2f(-0.625f, 0.39f);
      glVertex2f( 0.5f, 0.39f);
      glVertex2f( 0.5f,  0.41f);
      glVertex2f( -0.625f,  0.41f);
   glEnd();
   ...
   glBegin(GL_QUADS);
      glColor3f(0.0f, 0.0f, 0.0f);
      glVertex2f(-0.625f, 0.42f);
      glVertex2f( -0.625f, 0.44f);
   ...
   renderBitmapString(-.5,.6,(void *)font1,"AIUB");
...
glPushMatrix();
glTranslatef(-.37,-.57,0);
    int i;

	GLfloat x=0.0f; GLfloat y=0.0f; GLfloat radius =.7f*.5;
	int triangleAmount = 80;
	GLfloat twicePi = 2.0f * 3.1417;
	...
	glBegin(GL_TRIANGLE_FAN);
		...
		for(i = 0; i <= triangleAmount;i++) {
			glVertex2f(
		            x + (radius * cos(i *  twicePi / triangleAmount)),
			    y + (radius * sin(i * twicePi / triangleAmount))*.4
			);
		}
	glEnd();
	...
	glBegin(GL_TRIANGLE_FAN);
		...
		for(i = 0; i <= triangleAmount;i++) {
			glVertex2f(
		            x + (radius * cos(i *  twicePi / triangleAmount)),
			    y + (radius * sin(i * twicePi / triangleAmount))*.3
			);
		}
	glEnd();

	//lamp bottom circle
	    x=0.0f; y=0.24f*.5;  radius =.17f*.5;
	triangleAmount = 80;
    twicePi = 2.0f * 3.1417;
...
//yellow part lamp
    ...
    glVertex2f(.17*.5,0.2*.5);
    glVertex2f(.15*.5,.5*.5);
    glVertex2f(0,.5*.5);
    glVertex2f(-.14*.5,.34*.5);
    glEnd();
...
void car() {
   ...
   glBegin(GL_QUADS);
      ...
      glVertex2f(-0.1875f, 0.0f);
      glVertex2f( 0.0f, 0.0f);
      glVertex2f( 0.0f, 0.1875f);
      glVertex2f(-0.1875f,  0.1875f);
   glEnd();
   glBegin(GL_POLYGON);
   glColor3f(0.0f, 0.0f, 1.0f);
   glVertex2f(0.0f, 0.0f);
   glVertex2f(0.1875f, 0.0f);
   glVertex2f(0.1875f, 0.125f);
   glVertex2f(0.125f, 0.1875f);
   glVertex2f(0.0f, 0.1875f);
   glEnd();

   glBegin(GL_QUADS);
      glColor3f(1.0f, 1.0f, 1.0f);
      glVertex2f(-0.0625f, 0.0625f);
      glVertex2f( -0.0625f, 0.125f);
      glVertex2f( -0.125f, 0.125f);
      glVertex2f(-0.125f,  0.0625f);
   glEnd();
 ...
 glBegin(GL_POLYGON);
   ...
   glEnd();
	...
	GLfloat x=.1f; GLfloat y=.0f; GLfloat radius =.05f;
	int triangleAmount = 20;
	GLfloat twicePi = 2.0f * 3.1417;

	glBegin(GL_TRIANGLE_FAN);
	    glColor3ub(139, 70, 19);
		glVertex2f(x, y);
		for(i = 0; i <= triangleAmount;i++) {
			glVertex2f(
		            x + (radius * cos(i *  twicePi / triangleAmount)),
...
GLfloat x=.2f; GLfloat y=.0f; GLfloat radius =.51f;
...
void moon()
{
	...
	GLfloat x=-.5f; GLfloat y=.97f; GLfloat radius =.06f;
...
{
    char text[120];
    sprintf(text, "AUIB CAMPUS VIEW",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -20 , 12 );
    ...
    sprintf(text,"  PRESS D FOR DAY VIEW",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
     ...
     sprintf(text,"  PRESS N FOR NIGHT VIEW",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
     ...
     sprintf(text,"  PRESS R FOR RAIN VIEW",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
    ...
    sprintf(text,"  CREATED BY GROUP-1",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -100 , 0 );
    for(int i = 0; text[i] != '\0'; i++)
    {
...
void rainview(void)
{
    ...
    glPushMatrix();
    glTranslatef(1.4-position1,-0.9,0);
    car();
    glPopMatrix();
...
void handleKeypress(unsigned char key, int x, int y) {
	switch (key) {
	    ...
	    case  'd':
            ...
            glutCreateWindow("DAY VIEW OF AIUB CAMPUS");
        ...
        case 'r':
	        ...
	        glutInitWindowSize(1240, 750);
            glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
            glutCreateWindow("RAINY VIEW OF AIUB CAMPUS");
            glutKeyboardFunc(handleKeypress);
        ...
        sndPlaySound("rain.wav",SND_ASYNC|SND_LOOP);
         ...
         case 'n':
	        ...
	        glutInitWindowSize(1240, 750);
            glutInitWindowPosition((glutGet(GLUT_SCREEN_WIDTH)-1240)/2,(glutGet(GLUT_SCREEN_HEIGHT)-750)/2);
            glutCreateWindow("NIGHT VIEW OF AIUB CAMPUS");
            glutKeyboardFunc(handleKeypress);
